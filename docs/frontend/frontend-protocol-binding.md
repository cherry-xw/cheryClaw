...
>
> **不是**：协议字段定义（见 [docs/shared/protocol/websocket.md](../shared/protocol/websocket.md)）、交互序列样例（见 [docs/shared/protocol/interactions.md](../shared/protocol/interactions.md)）、R4 重构执行细节（见 [docs/frontend/frontend-refactor-handoff.md](archive/frontend-refactor-handoff.md)）。
>
> **目标读者**：
...
> 兼容期组件的现状，不应覆盖 [multi-agent-canonical-timeline.md](../shared/architecture/canonical-timeline.md) 的 V2 契约。
...
| 问 | 答案写在 |
|----|---------|
| 后端契约是否需要 vitest 流程测试？ | 加 `test/flows/service/flowXxx.test.ts`（见 [docs/quality/testing/flows.md](../quality/testing/flows.md)）|
...
- 协议字段定义 / wire 格式 / 错误码全集 —— [docs/shared/protocol/websocket.md](../shared/protocol/websocket.md)
- 端到端交互序列样例 —— [docs/shared/protocol/interactions.md](../shared/protocol/interactions.md)
- F1-F5 重构执行细节 —— [docs/frontend/frontend-refactor-handoff.md](archive/frontend-refactor-handoff.md)
- 后端 Middleware / Sense / Provider 实现 —— [docs/backend/agent/](../backend/agent/) + [docs/backend/core/](../backend/core/)
- 多 agent 唤醒策略（immediate/deferred/barrier）—— [docs/shared/architecture/agent-orchestration.md §5.4](../shared/architecture/agent-orchestration.md)
- WS 服务端实现 —— [docs/backend/service/websocket.md](../backend/service/websocket.md)

---

## 7. 参考资源

- 协议规范：[docs/shared/protocol/websocket.md](../shared/protocol/websocket.md)
- 交互序列：[docs/shared/protocol/interactions.md](../shared/protocol/interactions.md)
- 流程测试：[docs/quality/testing/flows.md](../quality/testing/flows.md)
- Agent-pet 唤醒策略：[docs/shared/architecture/agent-orchestration.md](../shared/architecture/agent-orchestration.md)
- Sub-agent Live Stream（spawn_role eager 启动）：[docs/shared/architecture/agent-orchestration.md §5.4](../shared/architecture/agent-orchestration.md) + 本手册 §2.10
- WebSocket 服务端：[docs/backend/service/websocket.md](../backend/service/websocket.md)
- F1-F5 前端重构：[docs/frontend/frontend-refactor-handoff.md](archive/frontend-refactor-handoff.md)

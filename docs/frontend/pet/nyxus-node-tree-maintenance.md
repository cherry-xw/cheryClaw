...
- 1920×1080 浏览器基线下，普通详情面板宽度约 480px、可用高度不超过 640px 或 `100vh - 96px`；标题约 38px、页签约 32px，视觉使用 3–4px 小圆角、细分隔线和 6–10px 紧凑间距。**用户阅读性质的内容（中文正文、说明、参数值、结果、错误提示等）字号不得低于 12px**；仅装饰性字形（✓/ⓘ/✦ 等 aria-hidden 图形）与纯数字徽标可保留更小字号，规格详见 [../standards/ui-visual-and-interaction.md §1](../../standards/frontend/ui-visual-and-interaction.md)。
